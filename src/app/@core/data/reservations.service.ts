...
import { Reservation, SelectItem, User } from './models';
...
export class ReservationsService extends DataService {
    ...
    generateReservations(nbr: number, tariff: any, owner: User, property: Property) {
        ...
        for (let n = 0; n < nbr; n++) {
            ...
            this.documentsService.generateDocuments(4, 2, reservation, '/pages/reservations/' + reservation.id + '/edit');
