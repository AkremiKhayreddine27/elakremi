...
export class PaymentService extends DataService {
    ...
    createDepositPayment(price: number, reservation: Reservation, status: SelectItem, push = true) {
    ...
    createBailPayment(price: number, reservation: Reservation, status: SelectItem, push = true) {
    ...
    createRefundPayment(price: number, reservation: Reservation, status: SelectItem, push = true) {
